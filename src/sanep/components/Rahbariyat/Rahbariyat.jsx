                        ...
                        <div className="rahbariyat-users">
                            ...
                            <div className="rahbariyat-about">
                                ...
                                <h4 className="rahbar-qabul">
                                    Tel: <span>+998 (67) 226 49 26</span>
                                </h4>
                                <span className='line'></span>
                                <div className="rahbar-contact">
                                    <h4 className="rahbar-email">
                                        Email:
                                        <a href="/">jurabek.khasanov@ssv.uz</a>
                                    </h4>
                                    <h4 className="rahbar-qabul">
                        ...
                        <div className="rahbariyat-users">
                            ...
                            <div className="rahbariyat-about">
                                ...
                                <div className="rahbar-contact">
                                    <h4 className="rahbar-email">
                                        Email:
                                        <a href="/">xavas.abdukodirov@ssv.uz </a>
                                    </h4>
                                    <h4 className="rahbar-qabul">
                                        Qabul kunlari: <p>Seshanba payshanba</p>
                                    </h4>
                        ...
                        <div className="rahbariyat-users">
                            ...
                            <div className="rahbariyat-about">
                                ...
                                <div className="rahbar-contact">
                                    <h4 className="rahbar-email">
                                        Email:
                                        <a href="/">doniyor.suyunov@ssv.uz </a>
                                    </h4>
                                    <h4 className="rahbar-qabul">
                    ...
                    <div className="rahbariyat-card">
                        <div className="rahbariyat-users">
                            ...
                            <div className="rahbariyat-about">
                                ...
                                <h4 className="rahbar-qabul">
                                    Tel: <span>+998 (67) 225 41 74</span>
                                </h4>
                                <span className='line'></span>
                                <div className="rahbar-contact">
                                    <h4 className="rahbar-email">
                        ...
                        <div className="rahbariyat-users">
                            ...
                            <div className="rahbariyat-about">
                                ...
                                <h4 className="rahbar-qabul">
                                    Tel: <span>+998 (67) 000 00 00</span>
                                </h4>
                                <span className='line'></span>
                                <div className="rahbar-contact">
                                    <h4 className="rahbar-email">
                        ...
                        <div className="rahbariyat-users">
                            ...
                            <div className="rahbariyat-about">
                                ...
                                <h4 className="rahbar-qabul">
                                    Tel: <span>+998 (67) 796 22 72</span>
                                </h4>
                                <span className='line'></span>
                                <div className="rahbar-contact">
                                    <h4 className="rahbar-email">
